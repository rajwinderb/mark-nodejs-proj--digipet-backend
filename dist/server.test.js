...
describe("GET /digipet/ignore", () => {
    test("if the user has a digipet, it responds with a description about the ignore", () => __awaiter(void 0, void 0, void 0, function* () {
        // setup: reset digipet
        model_1.setDigipet(model_1.INITIAL_DIGIPET);
    ...
    it("delegates state change to the ignoreDigipet function", () => __awaiter(void 0, void 0, void 0, function* () {
        // setup: reset digipet and mock function
        model_1.setDigipet(model_1.INITIAL_DIGIPET);
        if (jest.isMockFunction(controller_1.ignoreDigipet) /* type guard */) {
            controller_1.ignoreDigipet.mockReset();
        }
        // act
        yield supertest_1.default(server_1.default).get("/digipet/ignore");
        // assert
        expect(controller_1.ignoreDigipet).toHaveBeenCalledTimes(1);
    }));
});
